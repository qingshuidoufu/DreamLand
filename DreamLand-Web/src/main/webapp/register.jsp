<%@ page contentType="text/html;charset=UTF-8"%>  <%--设置中文类型防止文件乱码--%>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>   <%--jstl核心标签库--%>
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>  <%--jstl函数标准库--%>
<c:set var="ctx" value="${pageContext.request.contextPath }"/>   <%--用于设置标量值和对象属性--%>
<!doctype html>
<html lang="en">
<head>
	<meta charset="UTF-8">
